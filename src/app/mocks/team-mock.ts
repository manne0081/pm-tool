...
export const TEAM_MOCK: Team[] = [
    ...
    { id: 2, firstName: 'Jane', lastName: 'Smith', email: 'jane.smith@example.com', position: 'Product Manager', department: 'Product', hireDate: new Date('2018-09-10'), status: 'Aktiv', isManager: true, managerId: 1, phone: '+49 987 654321', location: 'Hamburg', profilePictureUrl: 'https://example.com/profiles/jane_smith.jpg', birthday: new Date('1985-12-12'), isRemote: false },
    { id: 3, firstName: 'Alex', lastName: 'Johnson', email: 'alex.johnson@example.com', position: 'UX Designer', department: 'Design', hireDate: new Date('2021-01-05'), status: 'Aktiv', isManager: false, phone: '+49 321 654987', location: 'Berlin', profilePictureUrl: 'https://example.com/profiles/alex_johnson.jpg', birthday: new Date('1992-07-19'), isRemote: false },
    { id: 4, firstName: 'Michael', lastName: 'Brown', email: 'michael.brown@example.com', position: 'DevOps Engineer', department: 'Engineering', hireDate: new Date('2017-03-25'), status: 'Aktiv', isManager: false, phone: '+49 213 987456', location: 'Frankfurt', profilePictureUrl: 'https://example.com/profiles/michael_brown.jpg', birthday: new Date('1987-11-03'), isRemote: true },
    { id: 5, firstName: 'Emily', lastName: 'Davis', email: 'emily.davis@example.com', position: 'HR Manager', department: 'Human Resources', hireDate: new Date('2016-08-17'), status: 'Aktiv', isManager: true, phone: '+49 432 156789', location: 'München', profilePictureUrl: 'https://example.com/profiles/emily_davis.jpg', birthday: new Date('1983-05-29'), isRemote: false },
    { id: 6, firstName: 'Robert', lastName: 'Miller', email: 'robert.miller@example.com', position: 'Marketing Specialist', department: 'Marketing', hireDate: new Date('2020-11-20'), status: 'Aktiv', isManager: false, phone: '+49 654 321987', location: 'Hamburg', profilePictureUrl: 'https://example.com/profiles/robert_miller.jpg', birthday: new Date('1991-08-15'), isRemote: true },
    { id: 7, firstName: 'Olivia', lastName: 'Wilson', email: 'olivia.wilson@example.com', position: 'Sales Manager', department: 'Sales', hireDate: new Date('2015-04-01'), status: 'Aktiv', isManager: true, phone: '+49 765 432198', location: 'Berlin', profilePictureUrl: 'https://example.com/profiles/olivia_wilson.jpg', birthday: new Date('1989-02-10'), isRemote: false },
