...
export const HEADERMENU_MOCK: HeaderMenu[] = [
    ...
    { id: 3, name: 'workspace', hasDropdown: true, hasLink: false, title: 'Workspace', icon: 'icon-box-filled', showDropdown: false },
...
export const HEADERSUBMENU_MOCK: HeaderSubMenu[] = [
    { id: 0, name: 'task', parentName: 'workspace', title: 'Aufgaben', route: 'task', parentForMenuItemState: 'workspace', markAsFavorite: false },
    { id: 1, name: 'calendar', parentName: 'workspace', title: 'Kalender', route: 'calendar', parentForMenuItemState: 'workspace', markAsFavorite: false },
    { id: 2, name: 'message', parentName: 'workspace', title: 'Nachrichten', route: 'message', parentForMenuItemState: 'workspace', markAsFavorite: false },
